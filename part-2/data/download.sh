...
kaggle competitions download -c soil-classification-part-2 -p "$TARGET_DIR" >/dev/null &
spinner $!
...
# 3. Download dataset to $TARGET_DIR
echo -e "${GREEN}⬇️  Downloading negative samples...${NC}"
kaggle datasets download yashkc2025/imagenet-1000 -p "$TARGET_DIR" >/dev/null &
spinner $!
...
if [[ "$download_model" == "y" || "$download_model" == "Y" ]]; then
    model_link="https://s3.tebi.io/annam/pt_2_f1_9919_lr_0001.pth"
